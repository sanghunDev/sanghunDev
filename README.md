...
<!-- 이 표는 progreneur.com/api/projects 에서 자동 생성됩니다. 직접 수정하지 마세요 (sync-projects 워크플로가 덮어씁니다). -->
...
| [눈치](https://nunchi.progreneur.com/) | AI가 내 말을 어떻게 알아들었는지 보면서, 시키는 법을 직접 해보며 배우는 무료 웹 서비스 | 운영 중 |
